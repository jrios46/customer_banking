...
def main():
    ...
    savings_maturity = int (input('What is the APR for the savings account? '))
    ...
    print("The balance is: $", format(updated_savings_balance.set_balance(), ',.2f'))
    print("The balance is: $", format(interest_earned.set_interest(), ',.2f'))
    ...
    # ADD YOUR CODE HERE
    print('Here are the details of the savings account.')
    print("The balance is: $", format(updated_cd_balance.set_balance(), ',.2f'))
    print("The balance is: $", format(interest_earned.set_balance(), ',.2f'))
